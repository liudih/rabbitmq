...
public class ProductEntity implements Serializable {
	...
	// 促销价
	public List<PromotionSalePrice> promotionPrice = new ArrayList<PromotionSalePrice>();
	// 是否促销
	public Boolean isOnSale = false;
	// 成本价
	public Double costPrice;
	// 原价
	public Double yjPrice;
	// 重量
	...
	public List<PromotionSalePrice> getPromotionPrice() {
		return promotionPrice;
	}

	public void setPromotionPrice(List<PromotionSalePrice> promotionPrice) {
